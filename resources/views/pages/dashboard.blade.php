              ...
              <div class="dashboard-content">
                  ...
                  <div class="col-md-4">
                    <div class="card mb-2">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle">Rp215.209</div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="card mb-2">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle">22.000.000</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row mt-3">
                  <div class="col-12 mt-2">
                    ...
                    >
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-4">Indomie</div>
                          <div class="col-md-3">Angga arew</div>
                          <div class="col-md-3">11 January 2021</div>
                          <div class="col-md-1 d-none d-md-block">
                            <img
                              src="/images/dashboard-arrow-right.svg"
                    ...
                    <a
                      href="/dasboard-transaction-detail.html"
                      class="card card-list d-block"
                    >
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-4">marijan</div>
                          <div class="col-md-3">risky</div>
                          <div class="col-md-3">11 January 2021</div>
                          <div class="col-md-1 d-none d-md-block">
                            <img
                              src="/images/dashboard-arrow-right.svg"
